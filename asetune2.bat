...
rem ------------------------------------------------------------------------
rem --- remove last '\' char from: ASETUNE_HOME and SYBASE
rem --- ASETUNE_HOME exists every time, while SYBASE is NOT mandatory
rem --- Also for SYBASE
...
rem ------------------------------------------------------------------------
IF %ASETUNE_HOME:~-1%==\ SET ASETUNE_HOME=%ASETUNE_HOME:~0,-1%
...
IF NOT DEFINED ASETUNE_HOME GOTO no_asetunehome
...
set classpath=%classpath%;%ASETUNE_HOME%\lib\ngdbc.jar
...
set classpath=%classpath%;%ASETUNE_HOME%\lib\proxy-vole_20131209.jar
...
java %JVM_MEMORY_PARAMS% %JVM_GC_PARAMS% %JVM_PARAMS% -Dsybase.home="%SYBASE%" -DSYBASE="%SYBASE%" -DAPPL_HOME="%SQLW_HOME%" -DASETUNE_HOME="%ASETUNE_HOME%" -DASETUNE_SAVE_DIR="%ASETUNE_SAVE_DIR%" %EXTRA% %DEBUG_OPTIONS% %SPLASH% com.asetune.AseTune2 %*
