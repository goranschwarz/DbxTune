...
set classpath=%classpath%;%TAILW_HOME%\lib\h2-1.3.169.jar
...
set classpath=%classpath%;%TAILW_HOME%\lib\swingx-all-1.6.4.jar
...
set classpath=%classpath%;%TAILW_HOME%\lib\proxy-vole_20121203.jar
...
set classpath=%classpath%;%TAILW_HOME%\lib\jcommon-1.0.17.jar
set classpath=%classpath%;%TAILW_HOME%\lib\jfreechart-1.0.14.jar
...
set classpath=%classpath%;%TAILW_HOME%\lib\jsqlparser.jar
