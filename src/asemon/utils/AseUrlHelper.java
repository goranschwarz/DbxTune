...
//		_logger.setLevel(Level.DEBUG);
	...
	private AseUrlHelper(String originUrl, String serverName, Map hostPort, String dbname, Map options)
	{
...
//			{
//				String key = (String) it.next();
//				String val = (String) _hostPort.get(key);
//
...
//		{
//			for (Iterator it = _options.keySet().iterator(); it.hasNext();)
//			{
//				String key = (String) it.next();
//				String val = (String) _options.get(key);
//
//				sb.append(key).append("=").append(val);
//
//				if (it.hasNext())
...
//		}
	 ...
	 */
	public static String buildUrlString(Map hostPort, String dbname, Map options)
	{
		if (_logger.isDebugEnabled())
