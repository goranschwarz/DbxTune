...
implements SybMessageHandler
{
	...
	private List          _discardMsgNum = new LinkedList(); // list of <Integer>
	private List          _discardMsgStr = new LinkedList(); // list of <String>
