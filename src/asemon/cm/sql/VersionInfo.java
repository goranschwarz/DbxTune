...
//	public static Calendar SP_MISSING_STATS_CRDATE = new GregorianCalendar(2009, 12, 10); // YYYY, MM, DD
	...
	public static final String  SP_ASEMON_RA_STATS_CR_STR     = "2011-01-22";  // "YYYY-MM-DD"
	public static       Date    SP_ASEMON_RA_STATS_CRDATE     = null;
	...
	static
	{
		try
		{
			...
			SP_ASEMON_RA_STATS_CRDATE     = sdf.parse(SP_ASEMON_RA_STATS_CR_STR);
