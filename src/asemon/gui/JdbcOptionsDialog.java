...
//	private JButton                _apply           = new JButton("Apply");
	...
	private Map                    _inValues        = null;
	private Map                    _outValues       = null;
	...
	**---------------------------------------------------
	*/
	private JdbcOptionsDialog(Dialog owner, String driverClassName, String urlTemplate, Map inValues)
	{
		...
		if (_inValues == null)
			_inValues = new HashMap(); // create an empty on 
...
//		_owner           = owner;
	...
	public static Map showDialog(Dialog owner, String driverClassName, String urlTemplate, Map inValues)
	{
...
//			}
		...
		protected void refreshTable()
		{
			...
			Map inValuesCopy = new LinkedHashMap(_inValues);
			...
			int insertPos = 0;
			for (Iterator it = inValuesCopy.keySet().iterator(); it.hasNext();)
			{
				String key = (String) it.next();
				String val = (String) inValuesCopy.get(key);
...
//		getCnt.start();
		...
		Map output = JdbcOptionsDialog.showDialog(null, AseConnectionFactory.getDriver(), AseConnectionFactory.getUrlTemplate(), input);
