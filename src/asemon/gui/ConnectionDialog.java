...
//System.out.println(">>>>> checkForMonitorOptions");
		...
		boolean b = AseConnectionUtils.checkForMonitorOptions(_aseConn, _aseUser_txt.getText(), true, this);
...
//		Configuration conf = Configuration.getInstance(Configuration.TEMP);
		...
		int height = conf.getIntProperty("conn.dialog.window.height", 640);
