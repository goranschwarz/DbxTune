...
//}
	...
	public ColumnHeaderPropsEntry(String name, int modelPos, int viewPos, boolean isVisible, SortOrder sortOrder)
	{
		_colName   = name;
		_modelPos  = modelPos;
		_viewPos   = viewPos;
	...
	public String toString()
	{
		return _colName + "={modelPos="+_modelPos+",viewPos="+_viewPos+",isVisible="+_isVisible+",sortOrder="+_sortOrder+"}";
	}
