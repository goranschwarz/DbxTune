...
//	public static final String VERSION_STRING     = "1.0.0";
	public static final String VERSION_STRING     = "0.0.165.dev";
	public static final String BUILD_STRING       = "2011-01-12/build 65";

	public static final boolean IS_DEVELOPMENT_VERSION   = true; // if true: date expiration will be checked on startup
	public static final String  DEV_VERSION_EXPIRE_STR  = "2011-05-30";  // "YYYY-MM-DD"
	...
	public static final String APP_STORE_DIR = System.getProperty("user.home") + "/.asemon";
