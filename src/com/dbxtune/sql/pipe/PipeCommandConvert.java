...
//		sb.append("usage: grep [-v] [-r [-c <col>]] [-m] [-x] {[-e <regexp>] | [str]} \n");
		...
		sb.append("  \n");
		sb.append("  For example if someone inserts a UTF-8 encoded swedish char '�' into a ISO-8859-1 storage. \n");
		sb.append("  The stored value would probably be 'ö' instead of '�'... \n");
		sb.append("  Because the UTF-8 encoded value for '�' will be 2 bytes (c3 b6), hence 'ö'... \n");
