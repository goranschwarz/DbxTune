...
//				if ((attachSizeMb) < _attachHtmlContentMaxSizeMb)
		...
		catch (Exception ex)
		{
			...
			//           at com.dbxtune.pcs.report.senders.ReportSenderToMail.send(ReportSenderToMail.java:254)
			//           at com.dbxtune.pcs.report.DailySummaryReportAbstract.send(DailySummaryReportAbstract.java:209)
			//           at com.dbxtune.pcs.PersistWriterJdbc.createDailySummaryReport(PersistWriterJdbc.java:5074)
			//           at com.dbxtune.pcs.PersistWriterJdbc.access$200(PersistWriterJdbc.java:103)
			//           at com.dbxtune.pcs.PersistWriterJdbc$2.run(PersistWriterJdbc.java:790)
