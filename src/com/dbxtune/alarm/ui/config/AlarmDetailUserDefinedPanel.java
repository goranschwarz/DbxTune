		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if (template != null)
			{
				try 
				{
					...
					String replacePackage = "package com.dbxtune.alarm.ui.config.examples;";
...
//	}
	...
	private static String createSourceCode()
	{
		...
		if (returnStringBuilder)
		{
			...
			sb.append("package dbxtune; \n");
			sb.append(" \n");
			sb.append("import com.dbxtune.alarm.IUserDefinedAlarmInterrogator; \n");
			sb.append("import com.dbxtune.cm.CountersModel; \n");
			sb.append(" \n");
		...
		{
			File f = new File("C:\\projects\\DbxTune\\resources\\alarm-handler-src2\\dbxtune\\CmEngines.txt");
			try
			{
	...
	{
		File srcDir = new File("C:\\projects\\DbxTune\\resources\\alarm-handler-src2");
		File[] srcDirs = new File[]{ srcDir };
		
		String className     = "dbxtune.CmEngines";
		String classFileName = "dbxtune/CmEngines.java";
