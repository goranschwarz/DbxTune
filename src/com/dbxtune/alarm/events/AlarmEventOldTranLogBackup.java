...
extends AlarmEvent 
{
	...
	/**
	 * Alarm to indicate the we do not have any recent WAL or TransactionLog backups for a specific database.
	 * 
	 * @param cm
	 * @param dbname
	 */
	public AlarmEventOldTranLogBackup(CountersModel cm, Number thresholdInHours, String dbname, String lastBackupStartOrEndTime, int age)
	{
		super(
