...
public class AlarmEventStackDump
extends AlarmEvent 
{
	 ...
	 * @param dbname
	 */
	public AlarmEventStackDump(CountersModel cm, String errorlogMsg)
	{
		super(
				...
				"Stack Dump was found in the errorlog of '" + cm.getServerName() + "'.",
				null);
