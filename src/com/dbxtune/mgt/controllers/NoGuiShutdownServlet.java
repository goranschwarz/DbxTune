...
public class NoGuiShutdownServlet 
extends HttpServlet
{
...
//		resp.setCharacterEncoding("UTF-8");
		...
		_logger.info("SHUTDOWN was requested by the NO-GUI Management interface.");
		...
		if (CounterController.hasInstance())
		{
			...
			ShutdownHandler.shutdown("SHUTDOWN was requested by the NO-GUI Management interface.");
...
//			System.exit(ShutdownHandler.NORMAL_EXIT_CODE); // NORMAL_EXIT_CODE == 0
