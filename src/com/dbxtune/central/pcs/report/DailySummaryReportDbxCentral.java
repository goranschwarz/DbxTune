/*******************************************************************************
DailySummaryReportHanaTune * Copyright (C) 2010-2025 Goran Schwarz
 * 
...
public class DailySummaryReportDbxCentral 
extends DailySummaryReportCentralDefault
{
	@Override
	public void addReportEntries()
	{
		...
		addReportEntry( new DbxCentralDbInfo(this)     );

		// SQL
		//FIXME: addReportEntry( new SomeH2SpecificReport(this)   );

		// CPU, Swapping, MemoryFree
