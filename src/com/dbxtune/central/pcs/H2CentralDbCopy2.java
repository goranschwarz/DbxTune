...
import com.dbxtune.sql.ddl.SchemaCrawlerUtils;
import com.dbxtune.sql.ddl.SchemaCrawlerUtils.DdlType;
...
//	private static class DbCopyParams
//	{
//		public static final int     DEFAULT_DML_BATCH_SIZE = 10000;
//		public static final boolean DEFAULT_DML_USE_MERGE  = false;
//		
//		boolean ddlPrintExec  = false;
//		boolean ddlSkipErrors = true;
//
//		int     dmlBatchSize  = DEFAULT_DML_BATCH_SIZE;
//		boolean dmlUseMerge   = DEFAULT_DML_USE_MERGE; // default=false: auto enabled if target H2 db file exists 
//		
...
//		String sourceUrl;
//		File   sourceH2File;
//		DbxConnection sourceConn;
//
//		int    sourceDbxCentralDbVersion = -1; 
//
//		
//		String targetUser;
//		String targetPasswd;
//		String targetUrl;
//		File   targetH2File;
//		DbxConnection targetConn;
////		List<DbTable> targetPreTableList = new ArrayList<>(); // not really used... The MAIN is sourceTableList
//		
//		int    targetDbxCentralDbVersion = -1; 
//
...
//			String targetH2UrlOp = ";DATABASE_TO_UPPER=false;MAX_COMPACT_TIME=60000;COMPRESS=TRUE;WRITE_DELAY=30000";
//
//			// SOURCE
//			if (StringUtil.isNullOrBlank(sourceUser  )) sourceUser   = "sa";
//			if (StringUtil.isNullOrBlank(sourcePasswd)) sourcePasswd = "";
//
//			if (StringUtil.isNullOrBlank(sourceUrl))
//			{
//				sourceUrl = "jdbc:h2:file:"+sourceDbName+sourceH2UrlOp;
//			}
//			else
//			{
//				// Looks like a "plain file"
//				if ( ! sourceUrl.startsWith("jdbc:") )
//				{ 
//					String dbname = sourceUrl; 
//					if (dbname.endsWith(".mv.db")) 
//						dbname = dbname.substring(0, dbname.length()-".mv.db".length()); 
//					
//					targetDbName = dbname + "_NEW";
//					
//					sourceUrl = "jdbc:h2:file:"+dbname+sourceH2UrlOp;
//				}
//			}
//
//			// set H2 Database FILE
//			if (StringUtil.hasValue(sourceUrl) && sourceUrl.startsWith("jdbc:h2:file:"))
//			{
//				sourceH2File = new H2UrlHelper(sourceUrl).getDbFile(true);
//			}
//			
//			// TARGET
//			if (StringUtil.isNullOrBlank(targetUser  )) targetUser   = sourceUser;
//			if (StringUtil.isNullOrBlank(targetPasswd)) targetPasswd = sourcePasswd;
//			
//			if (StringUtil.isNullOrBlank(targetUrl))
//			{
//				targetUrl = "jdbc:h2:file:"+targetDbName+targetH2UrlOp;
//			}
//			else
//			{
//				// Looks like a "plain file"
...
//				{ 
//					String dbname = targetUrl; 
//					if (dbname.endsWith(".mv.db")) 
//						dbname = dbname.substring(0, dbname.length()-".mv.db".length()); 
//					targetUrl = "jdbc:h2:file:"+dbname+targetH2UrlOp;
//				}
//			}
//
//			// set H2 Database FILE
//			if (StringUtil.hasValue(targetUrl) && targetUrl.startsWith("jdbc:h2:file:"))
//			{
//				targetH2File = new H2UrlHelper(targetUrl).getDbFile(true);
//				if (targetH2File.exists())
//				{
//					_logger.info("The TARGET H2 database file already EXISTS, Enabling 'dmlUseMerge=true' for the transfer. Target H2 Database File='"+targetH2File+"'.");
//					dmlUseMerge = true;
//				}
//			}
//		}
...
//			}
			...
			try
			{
				...
				if (ok)
				{
					...
					//    format("Transfer: ...",
					String msg2 = String.format("          OK  %s                                         -->>  target rows: %9d, execTime: %s, totalPctDone: %d%%",
							spaces,
...
//				String error = "Unknown options: " + StringUtil.toCommaStr(cmd.getArgs());
			...
			{
				// Use: auto-close
				try( H2CentralDbCopy2 dbCopy = new H2CentralDbCopy2() )
				{
