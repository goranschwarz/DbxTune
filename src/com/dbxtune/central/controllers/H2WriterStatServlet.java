...
import com.dbxtune.central.pcs.H2WriterStat.StatEntry;
...
//		out.println("	<!-- <link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css' integrity='sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm' crossorigin='anonymous'> --> ");
		...
		out.println("	<script type='text/javascript' src='/scripts/chartjs-adapter-moment/1.0.1/chartjs-adapter-moment.min.js'></script> ");
		out.println("	<script type='text/javascript' src='/scripts/chartjs-plugin-zoom/2.2.0/chartjs-plugin-zoom.min.js'></script> ");
		out.println("	<script type='text/javascript' src='/scripts/chartjs-plugin-annotation/3.1.0/chartjs-plugin-annotation.min.js'></script> ");
		out.println(" ");
...
//		out.println("<div id='graphs' class='grid' >");
		...
		out.println("    <div id='div-osLoadAvg1m'         style='position:relative;height:300px;'> <canvas id='chart-osLoadAvg1m'        ></canvas> </div>");
		out.println("    <div id='div-h2ReadsPerSec'       style='position:relative;height:300px;'> <canvas id='chart-h2ReadsPerSec'      ></canvas> </div>");
		out.println("    <div id='div-h2WritesPerSec'      style='position:relative;height:300px;'> <canvas id='chart-h2WritesPerSec'     ></canvas> </div>");
		out.println("    <div id='div-h2PageCountPerSec'   style='position:relative;height:300px;'> <canvas id='chart-h2PageCountPerSec'  ></canvas> </div>");
		out.println("    <div id='div-h2FileSizeGrowKbSec' style='position:relative;height:300px;'> <canvas id='chart-h2FileSizeGrowKbSec'></canvas> </div>");
		out.println("    <div id='div-h2FileSizeGrowMbSec' style='position:relative;height:300px;'> <canvas id='chart-h2FileSizeGrowMbSec'></canvas> </div>");
		out.println("    <div id='div-h2FileSizeKb'        style='position:relative;height:300px;'> <canvas id='chart-h2FileSizeKb'       ></canvas> </div>");
		out.println("    <div id='div-h2FileSizeMb'        style='position:relative;height:300px;'> <canvas id='chart-h2FileSizeMb'       ></canvas> </div>");
		out.println("</div>");
...
//		out.println("            data: map_data_" + name + ",                                                                                                                                                            ");
		...
		out.println("                    font: { size: 10 }, // font size of text, default=12");
		out.println("                },");
		out.println("            },");
		out.println("            zoom: {");
		out.println("                zoom: {");
		out.println("                    mode: 'x',");
		out.println("                    drag: { enabled: true, threshold: 10 },");
		out.println("                },");
		out.println("            },");
		out.println("            tooltip: {");
		out.println("                callbacks: {");
		out.println("                    label: function (tooltipItem) {");
		out.println("                        // print numbers localized (typically 1234567.8 -> 1,234,567.8)");
		out.println("                        return tooltipItem.dataset.label + ': ' + tooltipItem.parsed.y.toLocaleString();");
		out.println("                    }");
		out.println("                }");
		out.println("            },");
		out.println("        },");
		...
		out.println("                time: {");
		out.println("                    parser: 'YYYY-MM-DD HH:mm:ss.SSS',");
		out.println("                    tooltipFormat: 'YYYY-MM-DD (dddd) HH:mm:ss',");
		out.println("                    displayFormats: {");
		out.println("                        millisecond: 'MMM D HH:mm',");
		...
		out.println("                grid: {");
		out.println("                    color: function(context) { return (context.tick && context.tick.value === 0) ? 'rgba(0, 0, 0, 0.25)' : 'rgba(0, 0, 0, 0.1)'; },");
		out.println("                },");
		out.println("            },");
		out.println("        },");
		out.println("    },");
