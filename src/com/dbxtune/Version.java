...
//	public static final String VERSION_STRING     = "4.6.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.6.0.66.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2026-07-12/build 616";

	public static final String GIT_DATE_STRING    = "2026-07-12";  // try to update this
