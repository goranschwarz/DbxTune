...
//	public static final String VERSION_STRING     = "4.6.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.6.0.42.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2026-04-17/build 591";

	public static final String GIT_DATE_STRING    = "2026-04-17";  // try to update this
