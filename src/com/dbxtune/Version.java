...
//	public static final String VERSION_STRING     = "4.5.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.5.0.97.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2025-04-22/build 547";

	public static final String GIT_DATE_STRING    = "2025-08-22";  // try to update this
...
//	public static final String APP_STORE_DIR = System.getProperty("user.home") + File.separator + ".dbxtune";
