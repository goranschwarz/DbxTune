...
//	public static final String VERSION_STRING     = "4.6.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.6.0.79.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2026-09-08/build 629";

	public static final String GIT_DATE_STRING    = "2026-09-08";  // try to update this
