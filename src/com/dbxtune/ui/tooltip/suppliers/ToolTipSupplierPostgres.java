...
public class ToolTipSupplierPostgres
extends ToolTipSupplierAbstractSql
{
	public ToolTipSupplierPostgres(Window owner, CompletionProviderAbstract compleationProvider, ConnectionProvider connectionProvider)
	{
	...
	{
		return StringUtil.envVariableSubstitution("${APPL_HOME}/resources/POSTGRES_tooltip_provider.xml");
	}
}
