...
public class AsetuneTokenMaker
{
	...
	{
//		System.setProperty(TokenMakerFactory.PROPERTY_DEFAULT_TOKEN_MAKER_FACTORY, "com.dbxtune.ui.rsyntaxtextarea.AsetuneTokenMakerFactory");
...
//		TokenMakerFactory.setDefaultInstance(tmf);
		...
		String pkg = "com.dbxtune.ui.rsyntaxtextarea.modes.";

		atmf.putMapping(com.dbxtune.ui.rsyntaxtextarea.AsetuneSyntaxConstants.SYNTAX_STYLE_SYBASE_RCL , pkg + "SybaseRclTokenMaker");
		atmf.putMapping(com.dbxtune.ui.rsyntaxtextarea.AsetuneSyntaxConstants.SYNTAX_STYLE_SYBASE_TSQL, pkg + "SybaseTSqlTokenMaker");

		atmf.putMapping(com.dbxtune.ui.rsyntaxtextarea.AsetuneSyntaxConstants.SYNTAX_STYLE_MSSQL_TSQL , pkg + "MicrosoftTSqlTokenMaker");

		atmf.putMapping(com.dbxtune.ui.rsyntaxtextarea.AsetuneSyntaxConstants.SYNTAX_STYLE_POSTGRES_TEXT_EXECUTION_PLAN , pkg + "PostgresTextPlanTokenMaker");
	}
