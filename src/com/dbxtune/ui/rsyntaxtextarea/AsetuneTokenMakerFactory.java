...
class AsetuneTokenMakerFactory extends AbstractTokenMakerFactory
	...
	public void initTokenMakerMap() {
		...
		putMapping(com.dbxtune.ui.rsyntaxtextarea.AsetuneSyntaxConstants.SYNTAX_STYLE_SYBASE_TSQL, pkg + "SybaseTSqlTokenMaker");
		putMapping(com.dbxtune.ui.rsyntaxtextarea.AsetuneSyntaxConstants.SYNTAX_STYLE_SYBASE_RCL , pkg + "SybaseRclTokenMaker");

		putMapping(com.dbxtune.ui.rsyntaxtextarea.AsetuneSyntaxConstants.SYNTAX_STYLE_MSSQL_TSQL , pkg + "MicrosoftTSqlTokenMaker");

		putMapping(com.dbxtune.ui.rsyntaxtextarea.AsetuneSyntaxConstants.SYNTAX_STYLE_POSTGRES_TEXT_EXECUTION_PLAN, pkg + "PostgresTextPlanTokenMaker");
