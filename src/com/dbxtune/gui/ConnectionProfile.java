...
//		_srvType = SrvType.valueOf(srvType);   // if we do this and it's a new entry then we will get: java.lang.IllegalArgumentException: No enum constant com.dbxtune.gui.ConnectionProfile.SrvType.TDS_RAX
