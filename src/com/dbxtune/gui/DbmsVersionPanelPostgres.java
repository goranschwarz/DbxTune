...
import com.dbxtune.sql.conn.info.DbmsVersionInfoPostgres;
import com.dbxtune.utils.StringUtil;
import com.dbxtune.utils.Ver;
import com.dbxtune.utils.VersionShort;

public class DbmsVersionPanelPostgres
extends DbmsVersionPanelAbstract
{
	private static final long serialVersionUID = 1L;
	private static Logger _logger = Logger.getLogger(DbmsVersionPanelOracle.class);

	public DbmsVersionPanelPostgres(ShowCmPropertiesDialog propDialog)
	{
		super(propDialog);
		
		setLabelAndTooltipMajor  (true,  9,  0, 99,  1, "Major",   "<html>Major version of the Server, Example: <b>9</b>.5.14</html>");
		setLabelAndTooltipMinor  (true,  5,  0, 99,  1, "Minor",   "<html>Minor version of the Server, Example: 9.<b>5</b>.14</html>");
		setLabelAndTooltipMaint  (true,  0,  0, 99,  1, "Maint",   "<html>Mintenance version of the Server, Example: 9.5.<b>14</b></html>");
...
//		return srvVersionStr;
	...
	{
		return new DbmsVersionInfoPostgres(getMinVersion());
	}
	...
	protected DbmsVersionInfo createDbmsVersionInfo()
	{
		...
		DbmsVersionInfoPostgres versionInfo = new DbmsVersionInfoPostgres(ver);
