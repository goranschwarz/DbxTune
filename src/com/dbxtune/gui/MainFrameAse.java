...
//		systmp.setProperty("system.predefined.sql.07.install.needsVersion",        "1500000");
		...
		systmp.setProperty("system.predefined.sql.08.install.scriptLocation",      com.dbxtune.cm.sql.VersionInfo.class.getName());
		...
		systmp.setProperty("system.predefined.sql.09.install.scriptLocation",      com.dbxtune.cm.sql.VersionInfo.class.getName());
