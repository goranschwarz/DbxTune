...
import com.dbxtune.config.dict.MonTablesDictionaryDb2;
...
extends MainFrame
{
	...
	@Override public String    getTablePopupDbmsVendorString() { return "db2"; }
	@Override public ImageIcon getApplicationIcon16() { return SwingUtils.readImageIcon(Version.class, "images/db2tune_icon_16.png"); };
	@Override public ImageIcon getApplicationIcon32() { return SwingUtils.readImageIcon(Version.class, "images/db2tune_icon_32.png"); };
...
//			@Override public boolean doInitDbServerConfigDictionary() { return true; } 
			@Override public boolean initDbServerConfigDictionary(DbxConnection conn, HostMonitorConnection hostMonConn, ConnectionProgressDialog cpd) throws Exception
			{
				...
				{
					cpd.setStatus("Getting DB2 Configurations");
...
//			@Override public boolean doInitCounterCollector()         { return false; } 
	...
	{
		MonTablesDictionaryDb2.initExtraMonTablesDictionary();
	}
	...
	public static final ImageIcon TCP_GROUP_ICON_SERVER        = SwingUtils.readImageIcon(Version.class, "images/tcp_group_icon_db2.png");
	...
	{
		return new DbmsVersionPanelDb2(showCmPropertiesDialog);
	}
}
