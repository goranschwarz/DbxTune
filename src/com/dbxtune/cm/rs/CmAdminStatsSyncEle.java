 ...
 */
public class CmAdminStatsSyncEle
extends CmAdminStatsAbstract
{
//	private static Logger        _logger          = Logger.getLogger(CmAdminStats.class);
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsSyncEle.class.getSimpleName();
	public static final String   MODULE_NAME      = "SYNCELE";
	public static final String   SHORT_NAME       = "SYNC Element";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsSyncEle(counterController, guiController);
	}

	public CmAdminStatsSyncEle(ICounterController counterController, IGuiController guiController)
	{
