 ...
 */
public class CmAdminStatsSqm
extends CmAdminStatsAbstract
{
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsSqm.class.getSimpleName();
	public static final String   MODULE_NAME      = "SQM";
	public static final String   SHORT_NAME       = "Stable Queue Manager";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsSqm(counterController, guiController);
	}

	public CmAdminStatsSqm(ICounterController counterController, IGuiController guiController)
	{
