 ...
 */
public class CmAdminStatsSqmr
extends CmAdminStatsAbstract
{
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsSqmr.class.getSimpleName();
	public static final String   MODULE_NAME      = "SQMR";
	public static final String   SHORT_NAME       = "SQM Reader";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsSqmr(counterController, guiController);
	}

	public CmAdminStatsSqmr(ICounterController counterController, IGuiController guiController)
	{
