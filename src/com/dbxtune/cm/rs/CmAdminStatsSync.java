 ...
 */
public class CmAdminStatsSync
extends CmAdminStatsAbstract
{
//	private static Logger        _logger          = Logger.getLogger(CmAdminStats.class);
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsSync.class.getSimpleName();
	public static final String   MODULE_NAME      = "SYNC";
	public static final String   SHORT_NAME       = "Thread Synchronization";
	...
	public CmAdminStatsSync(ICounterController counterController, IGuiController guiController)
	{
