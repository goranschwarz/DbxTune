 ...
 */
public class CmAdminStatsRsh
extends CmAdminStatsAbstract
{
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsRsh.class.getSimpleName();
	public static final String   MODULE_NAME      = "RSH";
	public static final String   SHORT_NAME       = "RSH";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsRsh(counterController, guiController);
	}

	public CmAdminStatsRsh(ICounterController counterController, IGuiController guiController)
	{
