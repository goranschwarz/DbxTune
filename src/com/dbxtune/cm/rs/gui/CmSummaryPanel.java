...
//		_localServerName_lbl  .setText("Local server name");
		...
		tooltip = "This is the internal server name in the RepServer";
...
//		_listeners_txt        .setEditable(false);
		...
		tooltip = "The version string taken from 'admin version'";
		_srvVersion_lbl       .setText("RS Version");
