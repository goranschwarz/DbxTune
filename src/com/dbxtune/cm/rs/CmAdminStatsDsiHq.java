 ...
 */
public class CmAdminStatsDsiHq
extends CmAdminStatsAbstract
{
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsDsiHq.class.getSimpleName();
	public static final String   MODULE_NAME      = "DSIHQ";
	public static final String   SHORT_NAME       = "DSI-HQ";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsDsiHq(counterController, guiController);
	}

	public CmAdminStatsDsiHq(ICounterController counterController, IGuiController guiController)
	{
