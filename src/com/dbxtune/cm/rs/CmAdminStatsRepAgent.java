 ...
 */
public class CmAdminStatsRepAgent
extends CmAdminStatsAbstract
{
//	private static Logger        _logger          = Logger.getLogger(CmAdminStats.class);
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsRepAgent.class.getSimpleName();
	public static final String   MODULE_NAME      = "REPAGENT";
	public static final String   SHORT_NAME       = "RepAgent Thread";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsRepAgent(counterController, guiController);
	}

	public CmAdminStatsRepAgent(ICounterController counterController, IGuiController guiController)
	{
