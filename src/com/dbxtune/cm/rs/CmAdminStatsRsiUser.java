 ...
 */
public class CmAdminStatsRsiUser
extends CmAdminStatsAbstract
{
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsRsiUser.class.getSimpleName();
	public static final String   MODULE_NAME      = "RSIUSER";
	public static final String   SHORT_NAME       = "RSI User";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsRsiUser(counterController, guiController);
	}

	public CmAdminStatsRsiUser(ICounterController counterController, IGuiController guiController)
	{
