 ...
 */
public class CmAdminStatsAobj
extends CmAdminStatsAbstract
{
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsAobj.class.getSimpleName();
	public static final String   MODULE_NAME      = "AOBJ";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsAobj(counterController, guiController);
	}

	public CmAdminStatsAobj(ICounterController counterController, IGuiController guiController)
	{
