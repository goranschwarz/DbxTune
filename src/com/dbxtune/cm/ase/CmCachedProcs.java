...
extends CountersModel
{
	...
	public List<CmSettingsHelper> getLocalSettings()
	{
		...
		list.add(new CmSettingsHelper("Sample Lightweight Procs from Statement Cache",        PROPKEY_sample_statementCacheObjects, Boolean.class, conf.getBooleanProperty(PROPKEY_sample_statementCacheObjects, DEFAULT_sample_statementCacheObjects), DEFAULT_sample_statementCacheObjects, CmCachedProcsPanel.TOOLTIP_sample_statementCacheObjects));
		list.add(new CmSettingsHelper("Sample Lightweight Procs from Dynamic SQL Statements", PROPKEY_sample_dynamicSqlObjects    , Boolean.class, conf.getBooleanProperty(PROPKEY_sample_dynamicSqlObjects    , DEFAULT_sample_dynamicSqlObjects    ), DEFAULT_sample_dynamicSqlObjects    , CmCachedProcsPanel.TOOLTIP_sample_dynamicSqlObjects));
