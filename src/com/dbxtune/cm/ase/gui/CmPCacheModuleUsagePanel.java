...
public class CmPCacheModuleUsagePanel
extends TabularCntrPanel
{
	private static final Logger  _logger	           = Logger.getLogger(CmPCacheModuleUsagePanel.class);
	private static final long    serialVersionUID      = 1L;

	private static final String  PROP_PREFIX           = CmPCacheModuleUsage.CM_NAME;
