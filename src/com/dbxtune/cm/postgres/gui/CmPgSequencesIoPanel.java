...
public class CmPgSequencesIoPanel
extends TabularCntrPanel
{
//	private static final Logger  _logger	           = Logger.getLogger(CmPgSequencesIoPanel.class);
	private static final long    serialVersionUID      = 1L;

	private JCheckBox l_sampleSystemTables_chk;

	public CmPgSequencesIoPanel(CountersModel cm)
	{
		super(cm);
...
//				list.add(new CmSettingsHelper("Sample System Tables", PROPKEY_sample_systemTables , Boolean.class, conf.getBooleanProperty(PROPKEY_sample_systemTables  , DEFAULT_sample_systemTables  ), DEFAULT_sample_systemTables, "Sample System Tables" ));
				...
				l_sampleSystemTables_chk.setSelected(conf.getBooleanProperty(CmPgSequencesIo.PROPKEY_sample_systemTables, CmPgSequencesIo.DEFAULT_sample_systemTables));
...
//		int     defaultIntOpt;
		...
		//-----------------------------------------
		defaultOpt = conf == null ? CmPgSequencesIo.DEFAULT_sample_systemTables : conf.getBooleanProperty(CmPgSequencesIo.PROPKEY_sample_systemTables, CmPgSequencesIo.DEFAULT_sample_systemTables);
		l_sampleSystemTables_chk = new JCheckBox("Include System Tables", defaultOpt);

		l_sampleSystemTables_chk.setName(CmPgSequencesIo.PROPKEY_sample_systemTables);
		...
		l_sampleSystemTables_chk.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if (conf == null) return;
				conf.setProperty(CmPgSequencesIo.PROPKEY_sample_systemTables, ((JCheckBox)e.getSource()).isSelected());
				conf.save();
	...
	{
		Configuration conf = Configuration.getCombinedConfiguration();
		boolean confProp = conf.getBooleanProperty(CmPgSequencesIo.PROPKEY_sample_systemTables, CmPgSequencesIo.DEFAULT_sample_systemTables);
