 ...
 ******************************************************************************/
package com.dbxtune.cm.mysql.gui;
...
//		_localServerName_lbl  .setText("Local server name");
		...
		tooltip = "This is the MySQL internal instance/server name.";
		...
		tooltip = "This is the hostname where MySQL is running";
		...
		tooltip = "This is the MySQL version.";
		...
		tooltip = "Date and time that the MySQL was started.";
...
//		_srvVersion_txt        .setText(cm.getAbsString (0, "atAtVersion").replaceFirst("Sybase IQ/", ""));  
