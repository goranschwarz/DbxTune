...
//	}
	...
	private static Map<String, Integer> createDefaultConfigValuesMap()
	{
		...
		map.put("CTR cleaner lock timeout (secs)",      5);
		map.put("Log records threshold to abort txn.",  10_000);
		map.put("Log size threshold to abort txn.",     10);
...
//	go
	...
	private static Map<String, String> createConfigSectionMap()
	{
		...
		map.put("CTR cleaner lock timeout (secs)",    SECTION_UNSPECIFIED);
		map.put("Log records threshold to abort txn.",SECTION_UNSPECIFIED);
		map.put("Log size threshold to abort txn.",   SECTION_UNSPECIFIED);
		map.put("SLOG memory quota percentage.",      SECTION_UNSPECIFIED);
		map.put("TempDB log records threshold",       SECTION_UNSPECIFIED);
		map.put("TempDB log size threshold",          SECTION_UNSPECIFIED);
		map.put("external rest endpoint enabled",     SECTION_UNSPECIFIED);
		map.put("external xtp dll gen util enabled",  SECTION_UNSPECIFIED);
	...
	private static Map<String, String> createConfigCommentMap()
	{
		...
		map.put("Log records threshold to abort txn.",NO_COMMENT);
		map.put("Log size threshold to abort txn.",   NO_COMMENT);
		map.put("SLOG memory quota percentage.",      NO_COMMENT);
		map.put("TempDB log records threshold",       NO_COMMENT);
		map.put("TempDB log size threshold",          NO_COMMENT);
		map.put("external rest endpoint enabled",     NO_COMMENT);
		map.put("external xtp dll gen util enabled",  NO_COMMENT);
