...
import com.dbxtune.check.CheckForUpdatesHana;
import com.dbxtune.config.dbms.IDbmsConfig;
import com.dbxtune.config.dict.MonTablesDictionary;
import com.dbxtune.config.dict.MonTablesDictionaryHana;
import com.dbxtune.gui.MainFrame;
import com.dbxtune.gui.MainFrameHana;
...
//	}
	...
	{
		return "conf" + File.separatorChar + "hanatune.user.properties";
	}

	@Override
	public String getSaveConfigFileName()
	{
		return "conf" + File.separatorChar + "hanatune.save.properties";
	}
