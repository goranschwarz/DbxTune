...
public class AlarmEventAgSecondaryCommitTimeLag
extends AlarmEvent 
{
	private static final long serialVersionUID = 1L;

	/**
	 * Alarm when "secondaryCommitTimeLag" is above a threshold for an Availability Group 
	 * 
	 * @param cm
	...
	public AlarmEventAgSecondaryCommitTimeLag(CountersModel cm, String agName, String serverName, String dbname, String secondaryCommitTimeLag, int threshold)
	{
		...
		setData("agName='" + agName + "', serverName='" + serverName + "': secondaryCommitTimeLag='" + secondaryCommitTimeLag + "'.");
	}
}
