...
//	public AlarmEventOsLoadAverageAdjusted(CountersModel cm, Number threshold, String hostname, RangeType rangeType, Number avg_1min, Number avg_5min, Number avg_15min)
//	{
//		super(
...
//	}
	...
	public AlarmEventOsLoadAverageAdjusted(String serviceInfoName, Number threshold, String hostname, RangeType rangeType, Number avg_1min, Number avg_5min, Number avg_15min, Number avg_30min, Number avg_60min)
	{
		super(
				Version.getAppName(), // serviceType
				hostname,             // serviceName
