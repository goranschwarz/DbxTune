 ...
 */
public abstract class CheckForUpdates2
{
	private static Logger _logger = Logger.getLogger(CheckForUpdates2.class);
...
//	protected static final String DEFAULT_WHATSNEW_URL =  "http://www.asetune.com/history.html";
	...
	private static CheckForUpdates2 _instance = null;
...
//	}
	...
	public static CheckForUpdates2 getInstance()
	{
		if (_instance == null)
	...
	public static void setInstance(CheckForUpdates2 instance)
	{
		_instance = instance;
	}
			...
			public void run()
			{
				...
				if (! checkSucceed())
				{
					if (owner != null && showFailure)
						CheckDialog.showDialog(owner, CheckForUpdates2.this);
...
//
////		System.setProperty("java.net.useSystemProxies", "true");
//		CheckForUpdates2.init();
//
////		System.setProperty("http.proxyHost", "www-proxy.dummy.se");
////		System.setProperty("http.proxyPort", "8080");
//
//		CheckForUpdates2 check = new CheckForUpdates2();
//
...
//
//
//		CheckForUpdates2 udcCheck = new CheckForUpdates2();
