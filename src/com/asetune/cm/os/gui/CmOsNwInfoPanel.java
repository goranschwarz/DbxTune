...
public class CmOsNwInfoPanel
extends TabularCntrPanel
{
//	private static final Logger  _logger	           = Logger.getLogger(CmOsNwInfoPanel.class);
	private static final long    serialVersionUID      = 1L;

//	private static final String  PROP_PREFIX           = CmOsNwInfo.CM_NAME;

	public CmOsNwInfoPanel(CountersModel cm)
	{
		super(cm);
