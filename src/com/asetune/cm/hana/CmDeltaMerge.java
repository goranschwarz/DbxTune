 ...
 */
public class CmDeltaMerge
extends CountersModel
{
//	private static Logger        _logger          = Logger.getLogger(CmServiceMemory.class);
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmDeltaMerge.class.getSimpleName();
	public static final String   SHORT_NAME       = "Delta Merge";
	...
	public static final String[] MON_TABLES       = new String[] {"M_DELTA_MERGE_STATISTICS"};
...
//		"MERGED_DELTA_RECORDS"
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmDeltaMerge(counterController, guiController);
	}

	public CmDeltaMerge(ICounterController counterController, IGuiController guiController)
	{
