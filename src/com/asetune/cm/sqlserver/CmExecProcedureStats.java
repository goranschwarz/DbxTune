...
import com.asetune.cm.sqlserver.gui.CmExecProcedureStatsPanel;
 ...
 */
public class CmExecProcedureStats
extends CountersModel
{
//	private static Logger        _logger          = Logger.getLogger(CmExecProcedureStats.class);
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmExecProcedureStats.class.getSimpleName();
	public static final String   SHORT_NAME       = "Procedures";
	public static final String   HTML_DESC        = 
		"<html>"
		+ "<p>"
		+ "Shows aggregate performance statistics for cached stored procedures. <br>"
		+ "The view returns one row for each cached stored procedure plan, and the lifetime of the row is as long as the stored procedure remains cached. <br>"
		+ "When a stored procedure is removed from the cache, the corresponding row is eliminated from this view. <br>"
...
//	public static final int      DEFAULT_POSTPONE_TIME          = 600; // every 10 minute
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmExecProcedureStats(counterController, guiController);
	}

	public CmExecProcedureStats(ICounterController counterController, IGuiController guiController)
	{
...
//	public static final int     DEFAULT_sample_lastXminutesTime   = 30;
	...
	public List<CmSettingsHelper> getLocalSettings()
	{
		...
		list.add(new CmSettingsHelper("Extra Where Clause",                           PROPKEY_sample_extraWhereClause , String .class, conf.getProperty       (PROPKEY_sample_extraWhereClause , DEFAULT_sample_extraWhereClause ), DEFAULT_sample_extraWhereClause, CmExecProcedureStatsPanel.TOOLTIP_sample_extraWhereClause ));
		list.add(new CmSettingsHelper("Show only SQL exected since last sample time", PROPKEY_sample_afterPrevSample  , Boolean.class, conf.getBooleanProperty(PROPKEY_sample_afterPrevSample  , DEFAULT_sample_afterPrevSample  ), DEFAULT_sample_afterPrevSample , CmExecProcedureStatsPanel.TOOLTIP_sample_afterPrevSample  ));
		list.add(new CmSettingsHelper("Show only SQL exected last 10 minutes",        PROPKEY_sample_lastXminutes     , Boolean.class, conf.getBooleanProperty(PROPKEY_sample_lastXminutes     , DEFAULT_sample_lastXminutes     ), DEFAULT_sample_lastXminutes    , CmExecProcedureStatsPanel.TOOLTIP_sample_lastXminutes     ));
		list.add(new CmSettingsHelper("Show only SQL exected last ## minutes",        PROPKEY_sample_lastXminutesTime , Integer.class, conf.getIntProperty    (PROPKEY_sample_lastXminutesTime , DEFAULT_sample_lastXminutesTime ), DEFAULT_sample_lastXminutesTime, CmExecProcedureStatsPanel.TOOLTIP_sample_lastXminutesTime ));
	...
	{
		return new CmExecProcedureStatsPanel(this);
	}
