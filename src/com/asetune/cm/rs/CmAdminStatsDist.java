 ...
 */
public class CmAdminStatsDist
extends CmAdminStatsAbstract
{
//	private static Logger        _logger          = Logger.getLogger(CmAdminStats.class);
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsDist.class.getSimpleName();
	public static final String   MODULE_NAME      = "DIST";
	public static final String   SHORT_NAME       = "Distributor";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsDist(counterController, guiController);
	}

	public CmAdminStatsDist(ICounterController counterController, IGuiController guiController)
	{
