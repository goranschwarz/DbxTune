 ...
 */
public class CmAdminStatsSqt
extends CmAdminStatsAbstract
{
//	private static Logger        _logger          = Logger.getLogger(CmAdminStats.class);
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsSqt.class.getSimpleName();
	public static final String   MODULE_NAME      = "SQT";
	public static final String   SHORT_NAME       = "SQM Transaction Manager";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsSqt(counterController, guiController);
	}

	public CmAdminStatsSqt(ICounterController counterController, IGuiController guiController)
	{
