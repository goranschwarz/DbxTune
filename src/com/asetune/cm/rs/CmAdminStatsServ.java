 ...
 */
public class CmAdminStatsServ
extends CmAdminStatsAbstract
{
//	private static Logger        _logger          = Logger.getLogger(CmAdminStats.class);
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsServ.class.getSimpleName();
	public static final String   MODULE_NAME      = "SERV";
	public static final String   SHORT_NAME       = "Replication Server Global";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsServ(counterController, guiController);
	}

	public CmAdminStatsServ(ICounterController counterController, IGuiController guiController)
	{
