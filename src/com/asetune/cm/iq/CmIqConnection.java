...
//	private static Logger        _logger          = Logger.getLogger(CmAdminWhoSqm.class);
	...
	public static final String   SHORT_NAME       = "sp_iqconnection";
...
//	}
	...
	public void addMonTableDictForVersion(Connection conn, int srvVersion, boolean isClusterEnabled)
	{
		try 
		{
			...
			mtd.addTable("sp_iqconnection",  "FIXME.");

			mtd.addColumn("sp_iqconnection", "c1",  "<html>FIXME: c1</html>");
			mtd.addColumn("sp_iqconnection", "c2",  "<html>FIXME: c2</html>");
			mtd.addColumn("sp_iqconnection", "c3",  "<html>FIXME: c3</html>");
			mtd.addColumn("sp_iqconnection", "c4",  "<html>FIXME: c4</html>");
			mtd.addColumn("sp_iqconnection", "c5",  "<html>FIXME: c5</html>");
			mtd.addColumn("sp_iqconnection", "c6",  "<html>FIXME: c6/html>");
		}
