...
//		panel.add(new JLabel("Active STATEMENTS"),   "pushx, growx");
	...
	private GPanel createHistoricalStatementPanel()
	{
		...
		_historyStmntWhereSql_cbx         .setToolTipText("Add your extra where clauses on the monSysStatement table. make sure that only columns in the table are used. "+Version.getAppName()+"'s errorlog will show faulty SQL statements.");
