...
public class LastSampleForCmController 
extends HttpServlet
{
...
//		resp.setCharacterEncoding("UTF-8");
		...
		try
		{
			...
			if (Helper.hasUnKnownParameters(req, resp, "srv", "srvName", "cm", "cmName"))
				return;
...
//			}
			...
			Map<String, Map<String,String>> map = reader.getLastSampleForCm(input_srv, input_cmName);
