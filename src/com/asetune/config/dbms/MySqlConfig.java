...
extends DbmsConfigAbstract 
{
	...
	//   --------------------- --------- -------------- --------------- --------------------------------------------
		...
		{RUN_VALUE,            false,    String .class, "varchar(1024)", "Value of the configuration 'Value' ."},
		...
		{CONFIG_VALUE,         false,    String .class, "varchar(1024)", "DELETEME?: The value which will be configured on next restart, if PENDING is true."},
		{DEFAULT_VALUE,        false,    String .class, "varchar(1024)", "DELETEME?: The default configuration value."},
