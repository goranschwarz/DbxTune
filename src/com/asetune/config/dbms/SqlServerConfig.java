...
extends DbmsConfigAbstract 
{
	...
	//   --------------------- --------- -------------- --------------- --------------------------------------------
		...
		{RUN_VALUE,            true,     Integer.class, "varchar(255)",  "Value of the configuration 'run_value' ."},
		{PENDING,              false,    Boolean.class, "bit",           "The Configuration has not yet taken effect, probably needs restart to take effect."},
		{CONFIG_VALUE,         true,     Integer.class, "varchar(255)",  "The value which will be configured on next restart, if PENDING is true."},
		{DEFAULT_VALUE,        true,     Integer.class, "varchar(100)",  "The default configuration value."},
