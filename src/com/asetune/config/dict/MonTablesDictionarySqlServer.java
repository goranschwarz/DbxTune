...
//
	...
	public static void initExtraMonTablesDictionary()
	{
		...
		try
		{
			...
			// Column names and description
			mtd.addColumn("dm_exec_plan_attributes", "attribute"   , "<html><p>Name of the attribute associated with this plan. One of the following:</p><div> <div class=\"contentTableWrapper\">  <table responsive=\"true\">   <tbody>    <tr>     <th><p>Attribute</p></th>     <th><p>Data type</p></th>     <th><p>Description</p></th>    </tr>    <tr>     <td data-th=\"Attribute\"><p>set_options</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Indicates the option values that the plan was compiled with.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>objectid</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>One of the main keys used for looking up an object in the cache. This is the object ID stored in <a href=\"https://msdn.microsoft.com/en-us/library/ms190324.aspx\">sys.objects</a> for database objects (procedures, views, triggers, and so on). For plans of type \"Adhoc\" or \"Prepared\", it is an internal hash of the batch text.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>dbid</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Is the ID of the database containing the entity the plan refers to.</p><p>For ad hoc or prepared plans, it is the database ID from which the batch is executed.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>dbid_execute</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>For system objects stored in the <strong>Resource</strong> database, the database ID from which the cached plan is executed. For all other cases, it is 0.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>user_id</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Value of -2 indicates that the batch submitted does not depend on implicit name resolution and can be shared among different users. This is the preferred method. Any other value represents the user ID of the user submitting the query in the database.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>language_id</p></td>     <td data-th=\"Data type\"><p><strong>smallint</strong></p></td>     <td data-th=\"Description\"><p>ID of the language of the connection that created the cache object. For more information, see <a href=\"https://msdn.microsoft.com/en-us/library/ms190303.aspx\">sys.syslanguages (Transact-SQL)</a>.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>date_format</p></td>     <td data-th=\"Data type\"><p><strong>smallint</strong></p></td>     <td data-th=\"Description\"><p>Date format of the connection that created the cache object. For more information, see <a href=\"https://msdn.microsoft.com/en-us/library/ms189491.aspx\">SET DATEFORMAT (Transact-SQL)</a>.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>date_first</p></td>     <td data-th=\"Data type\"><p><strong>tinyint</strong></p></td>     <td data-th=\"Description\"><p>Date first value. For more information, see <a href=\"https://msdn.microsoft.com/en-us/library/ms181598.aspx\">SET DATEFIRST (Transact-SQL)</a>.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>status</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Internal status bits that are part of the cache lookup key.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>required_cursor_options</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Cursor options specified by the user such as the cursor type. </p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>acceptable_cursor_options</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Cursor options that SQL Server may implicitly convert to in order to support the execution of the statement. For example, the user may specify a dynamic cursor, but the query optimizer is permitted to convert this cursor type to a static cursor. </p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>inuse_exec_context</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Number of currently executing batches that are using the query plan.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>free_exec_context</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Number of cached execution contexts for the query plan that are not being currently used.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>hits_exec_context</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Number of times the execution context was obtained from the plan cache and reused, saving the overhead of recompiling the SQL statement. The value is an aggregate for all batch executions so far.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>misses_exec_context</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Number of times that an execution context could not be found in the plan cache, resulting in the creation of a new execution context for the batch execution.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>removed_exec_context</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Number of execution contexts that have been removed because of memory pressure on the cached plan.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>inuse_cursors</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Number of currently executing batches containing one or more cursors that are using the cached plan.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>free_cursors</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Number of idle or free cursors for the cached plan.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>hits_cursors</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Number of times that an inactive cursor was obtained from the cached plan and reused. The value is an aggregate for all batch executions so far.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>misses_cursors</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Number of times that an inactive cursor could not be found in the cache. </p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>removed_cursors</p></td>     <td data-th=\"Data type\"><p><strong>int</strong></p></td>     <td data-th=\"Description\"><p>Number of cursors that have been removed because of memory pressure on the cached plan.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>sql_handle</p></td>     <td data-th=\"Data type\"><p><strong>varbinary</strong>(64)</p></td>     <td data-th=\"Description\"><p>The SQL handle for the batch.</p></td>    </tr>    <tr>     <td data-th=\"Attribute\"><p>merge_action_type</p></td>     <td data-th=\"Data type\"><p><strong>smallint</strong></p></td>     <td data-th=\"Description\"><p>The type of trigger execution plan used as the result of a MERGE statement. </p><p>0 indicates a non-trigger plan, a trigger plan that does not execute as the result of a MERGE statement, or a trigger plan that executes as the result of a MERGE statement that only specifies a DELETE action.</p><p>1 indicates an INSERT trigger plan that runs as the result of a MERGE statement.</p><p>2 indicates an UPDATE trigger plan that runs as the result of a MERGE statement.</p><p>3 indicates a DELETE trigger plan that runs as the result of a MERGE statement containing a corresponding INSERT or UPDATE action.</p><p>For nested triggers run by cascading actions, this value is the action of the MERGE statement that caused the cascade.</p></td>    </tr>   </tbody>  </table> </div></div><p></p></html>");
