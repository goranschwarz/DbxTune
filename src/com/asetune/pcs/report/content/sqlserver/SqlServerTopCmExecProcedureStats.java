...
{
	private static Logger _logger = Logger.getLogger(SqlServerTopCmExecProcedureStats.class);
...
//		sb.append("Row Count: " + _shortRstm.getRowCount() + "<br>\n");
	...
	{
		return "Top Procedure Calls (order by: total_worker_time, origin: CmExecProcedureStats/dm_exec_procedure_stats)";
	}
...
//			}
	...
	private void setSectionDescription(ResultSetTableModel rstm)
	{
		...
		// Section description
		rstm.setDescription(
				"Top Procedures (and it's Query Plan)...  (ordered by: total_worker_time__sum) <br>" +
				"<br>" +
