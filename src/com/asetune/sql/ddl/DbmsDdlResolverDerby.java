...
public class DbmsDdlResolverDerby 
extends DbmsDdlResolverAbstract
{

	public DbmsDdlResolverDerby(DbxConnection conn)
	{
		super(conn);
	}
	...
	public String dbmsVendorDataTypeResolverForTarget(int javaSqlType, int length, int scale)
	{
		...
		case java.sql.Types.TINYINT:                 return "smallint";  // Derby do not have tinyint, so emulate with smallint or possibly ???
		...
		case java.sql.Types.LONGVARCHAR:             return "long varchar";
		case java.sql.Types.DATE:                    return "date";
		case java.sql.Types.TIME:                    return "time";
		case java.sql.Types.TIMESTAMP:               return "timestamp";
		case java.sql.Types.BINARY:                  return "char("+length+") for bit data";
		case java.sql.Types.VARBINARY:               return "char("+length+") for bit data";
		case java.sql.Types.LONGVARBINARY:           return "long varchar for bit data";
		...
		case ExtendedTypes.DBXTUNE_TYPE_JSON:        return "clob";
