...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- NOTE: This is a clone of https://github.com/JustinPealing/html-query-plan/blob/master/src/qp.xslt so if the source is changed, this may need attention -->
...
-->
	<pre>
---- BEGIN: SQL Statement Executed ------------------------------------
<xsl:value-of select="@StatementText" />
---- END: SQL Statement Executed ------------------------------------
	</pre>
    <xsl:apply-templates select="s:QueryPlan/s:MissingIndexes/s:MissingIndexGroup" mode="MissingIndex" />
