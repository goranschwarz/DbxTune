...
public class Esp extends AbstractSysmonType
{
	public Esp(SpSysmon sysmon, CountersModel cm)
	{
		super(sysmon, cm);
	}

	public Esp(SpSysmon sysmon, long srvVersion, int sampleTimeInMs, List<List<Object>> data, int fieldName_pos, int groupName_pos, int instanceId_pos, int value_pos)
	{
