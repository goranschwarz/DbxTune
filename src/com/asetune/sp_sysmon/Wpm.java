...
public class Wpm extends AbstractSysmonType
{
	public Wpm(SpSysmon sysmon, CountersModel cm)
	{
		super(sysmon, cm);
	}

	public Wpm(SpSysmon sysmon, long srvVersion, int sampleTimeInMs, List<List<Object>> data, int fieldName_pos, int groupName_pos, int instanceId_pos, int value_pos)
	{
	...
	{
		return "Worker Process Management";
	}
