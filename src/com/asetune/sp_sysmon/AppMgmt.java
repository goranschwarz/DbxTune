...
public class AppMgmt extends AbstractSysmonType
{
	public AppMgmt(SpSysmon sysmon, CountersModel cm)
	{
		super(sysmon, cm);
	}

	public AppMgmt(SpSysmon sysmon, long srvVersion, int sampleTimeInMs, List<List<Object>> data, int fieldName_pos, int groupName_pos, int instanceId_pos, int value_pos)
	{
