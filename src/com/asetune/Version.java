...
//	public static final String VERSION_STRING     = "4.1.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.1.0.28.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2021-02-23/build 358";

	public static final String GIT_DATE_STRING    = "2021-02-23";  // try to update this
