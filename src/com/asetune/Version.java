...
//	public static final String VERSION_STRING     = "4.1.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.1.0.111.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2022-12-06/build 441";

	public static final String GIT_DATE_STRING    = "2022-12-01";  // try to update this
