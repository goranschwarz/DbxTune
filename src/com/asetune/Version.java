...
//	public static final String VERSION_STRING     = "4.5.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.5.0.34.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2023-11-02/build 484";

	public static final String GIT_DATE_STRING    = "2023-11-02";  // try to update this
