...
//	public static final String VERSION_STRING     = "4.0.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.0.0.51.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2019-07-04/build 294";

	public static final String GIT_DATE_STRING    = "2019-07-04"; // try to update this
