...
//	public static final String VERSION_STRING     = "4.0.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.0.0.77.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2020-05-20/build 320";

	public static final String GIT_DATE_STRING    = "2020-05-20"; // try to update this
