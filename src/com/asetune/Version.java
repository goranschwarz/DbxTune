...
//	public static final String VERSION_STRING     = "4.1.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.1.0.81.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2022-02-05/build 411";

	public static final String GIT_DATE_STRING    = "2022-02-05";  // try to update this
