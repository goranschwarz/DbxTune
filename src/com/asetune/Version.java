...
//	public static final String VERSION_STRING     = "4.0.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.0.0.69.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2020-02-08/build 312";

	public static final String GIT_DATE_STRING    = "2020-02-08"; // try to update this
