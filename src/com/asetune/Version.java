...
//	public static final String VERSION_STRING     = "4.0.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.0.0.73.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2020-03-07/build 316";

	public static final String GIT_DATE_STRING    = "2020-03-07"; // try to update this
