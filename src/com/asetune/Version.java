...
//	public static final String VERSION_STRING     = "4.1.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.1.0.93.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2022-04-13/build 423";

	public static final String GIT_DATE_STRING    = "2022-04-13";  // try to update this
