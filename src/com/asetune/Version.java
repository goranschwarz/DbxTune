...
//	public static final String VERSION_STRING     = "4.1.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.1.0.41.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2021-04-23/build 371";

	public static final String GIT_DATE_STRING    = "2021-04-23";  // try to update this
