...
//	public static final String VERSION_STRING     = "4.0.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.0.0.72.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2020-02-14/build 315";

	public static final String GIT_DATE_STRING    = "2020-02-14"; // try to update this
