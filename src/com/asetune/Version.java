...
//	public static final String VERSION_STRING     = "4.5.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.5.0.40.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2023-12-15/build 490";

	public static final String GIT_DATE_STRING    = "2023-12-15";  // try to update this
