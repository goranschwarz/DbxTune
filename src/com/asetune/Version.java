...
//	public static final String VERSION_STRING     = "4.1.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.1.0.69.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2021-10-08/build 399";

	public static final String GIT_DATE_STRING    = "2021-10-08";  // try to update this
