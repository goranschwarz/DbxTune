...
//	public static final String VERSION_STRING     = "4.5.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.5.0.82.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2024-10-17/build 532";

	public static final String GIT_DATE_STRING    = "2024-10-17";  // try to update this
