...
//	public static final String VERSION_STRING     = "4.1.0";        // Use this for public releases
	public static final String VERSION_STRING     = "4.1.0.67.dev"; // Use this for early releases
	public static final String BUILD_STRING       = "2021-09-29/build 397";

	public static final String GIT_DATE_STRING    = "2021-09-29";  // try to update this
