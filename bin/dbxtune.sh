...
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/log4j-core-2.26.1.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/log4j-api-2.24.3.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/log4j-api-2.26.1.jar
...
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/log4j-slf4j2-impl-2.26.1.jar  ## Jetty is still using SL4J (Simple Log 4 Java) and this is a bridge to Log4j2
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/log4j-jul-2.24.3.jar          ## Others that are using Java Util Logging -- bridge to Log4j2
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/log4j-jul-2.26.1.jar          ## Others that are using Java Util Logging -- bridge to Log4j2
...
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/slf4j-api-2.0.20.jar          ## Jetty is still using SLF4J (Simple Log Facade 4 Java) and this is the API
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jul-to-slf4j-2.0.16.jar       ## Bridge for JUL to SLF4J used by SchemaCrawlerUtils
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jul-to-slf4j-2.0.20.jar       ## Bridge for JUL to SLF4J used by SchemaCrawlerUtils
...
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/miglayout-swing-11.4.3.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/miglayout-core-5.2.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/miglayout-core-11.4.3.jar
...
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-text-1.15.0.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-lang3-3.17.0.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-lang3-3.20.0.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-math3-3.6.1.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-io-2.17.0.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-io-2.22.0.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-csv-1.12.0.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-csv-1.14.1.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-cli-1.9.0.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-cli-1.11.0.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-codec-1.17.1.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/commons-codec-1.22.1.jar
...
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jakarta.mail-1.6.8.jar
...
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jsch-2.27.7.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jsch-2.28.7.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/rsyntaxtextarea-3.6.0.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/rsyntaxtextarea-3.6.1.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/rsyntaxtextarea-4.0.1.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/autocomplete-3.3.2.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/autocomplete-3.3.3.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/autocomplete-4.0.0.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/rstaui-3.3.1.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/rstaui-3.3.2.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/languagesupport-3.4.0.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/languagesupport-3.4.1.jar   ## Disabled: not compatible with RSTA 4.x (re-enable when RSTALanguageSupport 4.x exists)
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jcommon-1.0.24.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jfreechart-1.5.5.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jfreechart-1.5.6.jar
...
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jsqlparser-5.3.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jsqlparser-5.4-SNAPSHOT.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jsqlparser-5.4.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/bcprov-jdk18on-1.72.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/bcprov-jdk18on-1.86.jar
...
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/reflections-0.10.2.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/guava-33.3.1-jre.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/guava-33.7.1-jre.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/javassist-3.21.0-GA.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/javassist-3.33.0-GA.jar
...
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/velocity-engine-core-2.4.1.jar
...
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jackson-annotations-2.22.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jackson-core-2.18.0.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jackson-core-2.22.3.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jackson-databind-2.18.0.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/jackson-databind-2.22.3.jar
#export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/gson-2.11.0.jar
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/gson-2.14.0.jar
...
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/freemarker-2.3.35.jar
