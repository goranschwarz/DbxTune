...
set CLASSPATH=%CLASSPATH%;%DBXTUNE_HOME%\lib\jul-to-slf4j-2.0.20.jar
...
set CLASSPATH=%CLASSPATH%;%DBXTUNE_HOME%\lib\rsyntaxtextarea-3.6.1.jar
rem set CLASSPATH=%CLASSPATH%;%DBXTUNE_HOME%\lib\autocomplete-3.3.2.jar
set CLASSPATH=%CLASSPATH%;%DBXTUNE_HOME%\lib\autocomplete-3.3.3.jar
...
set CLASSPATH=%CLASSPATH%;%DBXTUNE_HOME%\lib\languagesupport-3.4.1.jar
