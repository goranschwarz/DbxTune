...
set title=StressConnect-console
title %title%
...
rem set SPLASH=-splash:lib/sqlw_splash.jpg
...
set classpath=%classpath%;%SQLW_HOME%\lib\h2-1.4.200.jar
set classpath=%classpath%;%SQLW_HOME%\lib\wizard.jar
set classpath=%classpath%;%SQLW_HOME%\lib\miglayout-swing-5.2.jar
set classpath=%classpath%;%SQLW_HOME%\lib\miglayout-core-5.2.jar
...
set classpath=%classpath%;%SQLW_HOME%\lib\commons-text-1.9.jar
set classpath=%classpath%;%SQLW_HOME%\lib\commons-lang3-3.7.jar
set classpath=%classpath%;%SQLW_HOME%\lib\commons-io-2.6.jar
set classpath=%classpath%;%SQLW_HOME%\lib\commons-csv-1.5.jar
set classpath=%classpath%;%SQLW_HOME%\lib\commons-cli-1.4.jar
set classpath=%classpath%;%SQLW_HOME%\lib\proxy-vole_20131209.jar
set classpath=%classpath%;%SQLW_HOME%\lib\ganymed-ssh2-263.jar
...
set classpath=%classpath%;%SQLW_HOME%\lib\SwingBox-bin.jar
set classpath=%classpath%;%SQLW_HOME%\lib\SwingBox-bin\*
