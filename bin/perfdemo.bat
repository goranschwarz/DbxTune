...
set classpath=%classpath%;%PERF_DEMO_HOME%\lib\h2-SNAPSHOT.jar
set classpath=%classpath%;%PERF_DEMO_HOME%\lib\h2-1.4.200.jar
set classpath=%classpath%;%PERF_DEMO_HOME%\lib\wizard.jar
set classpath=%classpath%;%PERF_DEMO_HOME%\lib\miglayout-swing-5.2.jar
set classpath=%classpath%;%PERF_DEMO_HOME%\lib\miglayout-core-5.2.jar
...
set classpath=%classpath%;%PERF_DEMO_HOME%\lib\commons-text-1.9.jar
set classpath=%classpath%;%PERF_DEMO_HOME%\lib\commons-lang3-3.7.jar
set classpath=%classpath%;%PERF_DEMO_HOME%\lib\commons-io-2.6.jar
...
set classpath=%classpath%;%PERF_DEMO_HOME%\lib\ganymed-ssh2-263.jar
