...
#--- XXX_HOME
#----------------------------------
APPL_HOME_propName="TAILW_HOME"

export TAILW_HOME=${TAILW_HOME:-$scriptPath}
export APPL_HOME=${TAILW_HOME}

#----------------------------------
#--- XXX_SAVE_DIR
#----------------------------------
APPL_SAVE_DIR_propName="TAILW_SAVE_DIR"

export TAILW_SAVE_DIR=${TAILW_SAVE_DIR:-$APPL_HOME/data}
export APPL_SAVE_DIR=${TAILW_SAVE_DIR}
...
export JVM_MEMORY_PARAMS_32=${TAILW_JVM_MEMORY_PARAMS_32:-"-Xmx1024m -Xms64m"}
export JVM_MEMORY_PARAMS_64=${TAILW_JVM_MEMORY_PARAMS_64:-"-Xmx2048m -Xms64m"}
...
export CLASSPATH=${CLASSPATH}:${APPL_HOME}/lib/h2-1.4.198.jar
...
export PATH=${TAILW_JAVA_HOME}/bin:${DBXTUNE_JAVA_HOME}/bin:${JAVA_HOME}/bin:${PATH}
cd ${APPL_HOME}
...
echo TAILW_JAVA_HOME=${TAILW_JAVA_HOME}
