...
export CLASSPATH=$CLASSPATH:$ASETUNE_HOME/lib/h2-1.3.155.jar
export CLASSPATH=$CLASSPATH:$ASETUNE_HOME/lib/wizard.jar
export CLASSPATH=$CLASSPATH:$ASETUNE_HOME/lib/miglayout-3.7.4-swing.jar
export CLASSPATH=$CLASSPATH:$ASETUNE_HOME/lib/swingx-core-1.6.2.jar
export CLASSPATH=$CLASSPATH:$ASETUNE_HOME/lib/jchart2d-3.2.1.jar
...
export CLASSPATH=$CLASSPATH:$ASETUNE_HOME/lib/proxy-vole_20110515.jar
