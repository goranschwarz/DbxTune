...
set title=HanaTune-console
title %title%

rem ------------------------------------------------------------------------
rem --- set HANATUNE_HOME to current directory if NOT already set
rem ------------------------------------------------------------------------
IF "%HANATUNE_HOME%"=="" set HANATUNE_HOME=%~dp0
...
rem ------------------------------------------------------------------------
rem --- remove last '\' char from: HANATUNE_HOME and SYBASE
rem --- HANATUNE_HOME exists every time, while SYBASE is NOT mandatory
rem --- Also for SYBASE
...
rem ------------------------------------------------------------------------
IF %HANATUNE_HOME:~-1%==\ SET HANATUNE_HOME=%HANATUNE_HOME:~0,-1%
...
rem ------------------------------------------------------------------------
set APPL_HOME=%HANATUNE_HOME%
set HANATUNE_SAVE_DIR=%HANATUNE_HOME%\data
...
rem ------------------------------------------------------------------------
echo NOTE: Set/Change JVM Memory parameters by setting Environment variable: HANATUNE_JVM_MEMORY_PARAMS 

set JVM_MEMORY_PARAMS_32=-Xmx1024m -Xms64m
set JVM_MEMORY_PARAMS_64=-Xmx2048m -Xms64m

IF DEFINED HANATUNE_JVM_MEMORY_PARAMS set JVM_MEMORY_PARAMS_32=%HANATUNE_JVM_MEMORY_PARAMS%
IF DEFINED HANATUNE_JVM_MEMORY_PARAMS set JVM_MEMORY_PARAMS_64=%HANATUNE_JVM_MEMORY_PARAMS%
...
IF DEFINED HANATUNE_JVM_GC_PARAMS set JVM_GC_PARAMS_32=%HANATUNE_JVM_GC_PARAMS%
IF DEFINED HANATUNE_JVM_GC_PARAMS set JVM_GC_PARAMS_64=%HANATUNE_JVM_GC_PARAMS%
...
IF NOT DEFINED HANATUNE_HOME GOTO no_hanatunehome
...
rem ------------------------------------------------------------------------
set classpath=%HANATUNE_HOME%\classes
set classpath=%classpath%;%HANATUNE_HOME%\lib\asetune.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\jconn4.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\jconn3.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\jtds-1.2.7.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\ngdbc.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\dsparser.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\log4j-1.2.17.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\h2-1.3.176.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\wizard.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\miglayout-swing-4.2.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\miglayout-core-4.2.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\swingx-all-1.6.5-1.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\jchart2d-3.2.2.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\planviewer.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\commons-cli-1.2.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\proxy-vole_20131209.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\ganymed-ssh2-build251beta1.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\rsyntaxtextarea.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\autocomplete.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\rstaui.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\jcommon-1.0.21.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\jfreechart-1.0.17.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\antlr-4.0-complete.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\juniversalchardet-1.0.3.jar
set classpath=%classpath%;%HANATUNE_HOME%\lib\DDLGen.jar
...
rem ------------------------------------------------------------------------
set PATH=%HANATUNE_JAVA_HOME%\bin;%JAVA_HOME%\bin;%PATH%
...
if %JavaBitness% == 64 (
	...
	echo NOTE: Java is a 64 bit, HanaTune will be allowed to use more memory
)
...
java %JVM_MEMORY_PARAMS% %JVM_GC_PARAMS% %JVM_PARAMS% -Dsybase.home="%SYBASE%" -DSYBASE="%SYBASE%" -DAPPL_HOME="%SQLW_HOME%" -DHANATUNE_HOME="%HANATUNE_HOME%" -DHANATUNE_SAVE_DIR="%HANATUNE_SAVE_DIR%" %EXTRA% %DEBUG_OPTIONS% %SPLASH% com.asetune.HanaTune %*
...
:no_hanatunehome
echo -----------------------------------------------------------------------
echo Error: no HANATUNE_HOME environment variable.
echo -----------------------------------------------------------------------
echo Must set the HANATUNE_HOME variable to the place where you installed HanaTune.
echo -----------------------------------------------------------------------
goto exit_hanatune
...
echo Current HANATUNE_JAVA_HOME variable is set to %HANATUNE_JAVA_HOME%
...
echo Subject: HanaTune starting problem
echo -----------------------------------------------------------------------
echo .
goto exit_hanatune
...
echo .
echo If you have a sql.ini file somewhere, HanaTune looks for it under %%SYBASE%%\ini\sql.ini.
