...
export CLASSPATH=$CLASSPATH:$ASEMON_HOME/lib/jcommon-1.0.14.jar
export CLASSPATH=$CLASSPATH:$ASEMON_HOME/lib/log4j-1.2.15.jar
...
java -cp $CLASSPATH $JVM_PARAMS -Dsybase.home=$SYBASE -DSYBASE=$SYBASE -DASEMON_HOME=$ASEMON_HOME -DASEMON_SAVE_DIR=$ASEMON_SAVE_DIR $EXTRA $DEBUG_OPTIONS asemon.Asemon
