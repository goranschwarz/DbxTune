...
set classpath=%classpath%;%DBXTUNE_HOME%\lib\h2-1.4.194.jar
...
set classpath=%classpath%;%DBXTUNE_HOME%\lib\slf4j-api-1.7.25.jar
set classpath=%classpath%;%DBXTUNE_HOME%\lib\slf4j-log4j12-1.7.25.jar
