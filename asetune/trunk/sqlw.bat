...
set classpath=%classpath%;%SQLW_HOME%\lib\log4j-1.2.16.jar
set classpath=%classpath%;%SQLW_HOME%\lib\h2-1.3.167.jar
...
set classpath=%classpath%;%SQLW_HOME%\lib\swingx-core-1.6.2-2.jar
...
set classpath=%classpath%;%SQLW_HOME%\lib\proxy-vole_20111102.jar
...
set classpath=%classpath%;%SQLW_HOME%\lib\jcommon-1.0.16.jar
set classpath=%classpath%;%SQLW_HOME%\lib\jfreechart-1.0.13.jar
