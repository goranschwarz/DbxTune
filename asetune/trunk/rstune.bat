...
set title=RsTune-console
title %title%

rem ------------------------------------------------------------------------
rem --- set RSTUNE_HOME to current directory if NOT already set
rem ------------------------------------------------------------------------
IF "%RSTUNE_HOME%"=="" set RSTUNE_HOME=%~dp0
...
rem ------------------------------------------------------------------------
rem --- remove last '\' char from: RSTUNE_HOME and SYBASE
rem --- RSTUNE_HOME exists every time, while SYBASE is NOT mandatory
rem --- Also for SYBASE
...
rem ------------------------------------------------------------------------
IF %RSTUNE_HOME:~-1%==\ SET RSTUNE_HOME=%RSTUNE_HOME:~0,-1%
...
rem ------------------------------------------------------------------------
set APPL_HOME=%RSTUNE_HOME%
set RSTUNE_SAVE_DIR=%RSTUNE_HOME%\data
...
rem ------------------------------------------------------------------------
echo NOTE: Set/Change JVM Memory parameters by setting Environment variable: RSTUNE_JVM_MEMORY_PARAMS 

set JVM_MEMORY_PARAMS_32=-Xmx1024m -Xms64m
set JVM_MEMORY_PARAMS_64=-Xmx2048m -Xms64m

IF DEFINED RSTUNE_JVM_MEMORY_PARAMS set JVM_MEMORY_PARAMS_32=%RSTUNE_JVM_MEMORY_PARAMS%
IF DEFINED RSTUNE_JVM_MEMORY_PARAMS set JVM_MEMORY_PARAMS_64=%RSTUNE_JVM_MEMORY_PARAMS%
...
IF DEFINED RSTUNE_JVM_GC_PARAMS set JVM_GC_PARAMS_32=%RSTUNE_JVM_GC_PARAMS%
IF DEFINED RSTUNE_JVM_GC_PARAMS set JVM_GC_PARAMS_64=%RSTUNE_JVM_GC_PARAMS%
...
IF NOT DEFINED RSTUNE_HOME GOTO no_rstunehome
...
rem ------------------------------------------------------------------------
set classpath=%RSTUNE_HOME%\classes
set classpath=%classpath%;%RSTUNE_HOME%\lib\asetune.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\jconn4.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\jconn3.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\jtds-1.2.7.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\ngdbc.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\dsparser.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\log4j-1.2.17.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\h2-1.3.176.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\wizard.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\miglayout-swing-4.2.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\miglayout-core-4.2.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\swingx-all-1.6.5-1.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\jchart2d-3.2.2.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\planviewer.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\commons-cli-1.2.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\proxy-vole_20131209.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\ganymed-ssh2-build251beta1.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\rsyntaxtextarea.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\autocomplete.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\rstaui.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\jcommon-1.0.21.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\jfreechart-1.0.17.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\antlr-4.0-complete.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\juniversalchardet-1.0.3.jar
set classpath=%classpath%;%RSTUNE_HOME%\lib\DDLGen.jar
...
rem ------------------------------------------------------------------------
set PATH=%RSTUNE_JAVA_HOME%\bin;%JAVA_HOME%\bin;%PATH%
...
if %JavaBitness% == 64 (
	...
	echo NOTE: Java is a 64 bit, RsTune will be allowed to use more memory
)
...
java %JVM_MEMORY_PARAMS% %JVM_GC_PARAMS% %JVM_PARAMS% -Dsybase.home="%SYBASE%" -DSYBASE="%SYBASE%" -DAPPL_HOME="%SQLW_HOME%" -DRSTUNE_HOME="%RSTUNE_HOME%" -DRSTUNE_SAVE_DIR="%RSTUNE_SAVE_DIR%" %EXTRA% %DEBUG_OPTIONS% %SPLASH% com.asetune.RsTune %*
...
:no_rstunehome
echo -----------------------------------------------------------------------
echo Error: no RSTUNE_HOME environment variable.
echo -----------------------------------------------------------------------
echo Must set the RSTUNE_HOME variable to the place where you installed RsTune.
echo -----------------------------------------------------------------------
goto exit_rstune
...
echo Current RSTUNE_JAVA_HOME variable is set to %RSTUNE_JAVA_HOME%
...
echo Subject: RsTune starting problem
echo -----------------------------------------------------------------------
echo .
goto exit_rstune
...
echo .
echo If you have a sql.ini file somewhere, RsTune looks for it under %%SYBASE%%\ini\sql.ini.
