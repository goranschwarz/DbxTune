...
public class SingleThreadStdoutStderr
{
	...
	{
		String hostname = "gorans.no-ip.org";
		String username = "gorans";
		String password = "1niss2e";
		...
		try
		{
			...
			sess.execCommand(
					"echo 'Huge amounts of text on STDOUT'; " +
					"echo 'Huge amounts of text on STDERR' >&2; " +
					"sleep 5;" +
					"echo 'Second text on STDOUT'; " +
					"echo 'Second text on STDERR' >&2; " +
					"sleep 5;" +
					"echo 'Third text on STDOUT'; " +
					"echo 'Third text on STDERR' >&2; " +
					"sleep 5;" +
					"echo 'LAST text on STDOUT'; " +
					"echo 'LAST text on STDERR' >&2; " +
					"iostat -x 1");
			...
			while (true)
			{
				System.out.println("At the top of loop");
