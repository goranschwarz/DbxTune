...
var svgLines_1 = __webpack_require__(3);
exports.drawLines = svgLines_1.drawSvgLines;
...
function onMouseout(node, event) {
    ...
    if (e == node ||
        utils_1.findAncestor(e, 'qp-node') == node ||
        (currentTooltip != null && (e == currentTooltip || utils_1.findAncestor(e, 'qp-tt') == currentTooltip))) {
        return;
    }
