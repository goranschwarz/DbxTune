...
//			"</html>");
		...
		_sampleSystemSpids_chk      = new JCheckBox("Show only SQL executed since last sample time",  conf == null ? CmPlanCacheDetails.DEFAULT_sample_afterPrevSample : conf.getBooleanProperty(CmPlanCacheDetails.PROPKEY_sample_afterPrevSample, CmPlanCacheDetails.DEFAULT_sample_afterPrevSample));
		...
		_sampleSystemSpids_chk     .setToolTipText(TOOLTIP_sample_afterPrevSample);
		...
		panel.add(_sampleSystemSpids_chk,      "wrap");
