 ...
 *
 */
public class CmIqDbspace
extends CountersModel
{
//	private static Logger        _logger          = Logger.getLogger(CmAdminWhoSqm.class);
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmIqDbspace.class.getSimpleName();
	public static final String   SHORT_NAME       = "dbspaces";
	...
	public static final String[] MON_TABLES       = new String[] {"sp_iqdbspace"};
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmIqDbspace(counterController, guiController);
	}

	public CmIqDbspace(ICounterController counterController, IGuiController guiController)
	{
...
//		return pkCols;
	...
	{
		String sql = "select * from sp_iqdbspace()";
