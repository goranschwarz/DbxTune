...
//	private static Logger        _logger          = Logger.getLogger(CmAdminWhoSqm.class);
	...
	public static final String   SHORT_NAME       = "sp_iqlocks";
...
//	}
	...
	public void addMonTableDictForVersion(Connection conn, int srvVersion, boolean isClusterEnabled)
	{
		try 
		{
			...
			mtd.addTable("sp_iqlocks",  "FIXME.");

			mtd.addColumn("sp_iqlocks", "c1",  "<html>FIXME: c1</html>");
			mtd.addColumn("sp_iqlocks", "c2",  "<html>FIXME: c2</html>");
			mtd.addColumn("sp_iqlocks", "c3",  "<html>FIXME: c3</html>");
			mtd.addColumn("sp_iqlocks", "c4",  "<html>FIXME: c4</html>");
			mtd.addColumn("sp_iqlocks", "c5",  "<html>FIXME: c5</html>");
			mtd.addColumn("sp_iqlocks", "c6",  "<html>FIXME: c6/html>");
		}
