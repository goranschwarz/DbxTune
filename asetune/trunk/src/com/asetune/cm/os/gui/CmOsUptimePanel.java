...
{
//	private static final Logger  _logger	           = Logger.getLogger(CmOsUptimePanel.class);
	private static final long    serialVersionUID      = 1L;

//	private static final String  PROP_PREFIX           = CmOsUptime.CM_NAME;

	public CmOsUptimePanel(CountersModel cm)
	{
		super(cm);
