...
public class CmOsMpstatPanel
extends TabularCntrPanel
{
//	private static final Logger  _logger	           = Logger.getLogger(CmOsMpstatPanel.class);
	private static final long    serialVersionUID      = 1L;

//	private static final String  PROP_PREFIX           = CmOsMpstat.CM_NAME;

	public CmOsMpstatPanel(CountersModel cm)
	{
		super(cm);
