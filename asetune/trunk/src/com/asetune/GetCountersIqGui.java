...
//public class GetCountersIqGui
//    extends GetCountersIq
//{
//	/** Log4j logging. */
//	private static Logger _logger          = Logger.getLogger(GetCountersIqGui.class);
...
//
//		// Set the Thread name
////		setName("GetCountersIqGUI");
//		_thread = Thread.currentThread();
//		_thread.setName("GetCountersIqGUI");
//
//		_running = true;
//		_logger.info("Starting GetCountersIq GUI collector");
//
//		// loop
//		int loopCounter = 0;
//
...
//							MainFrame.getInstance().setStatus(MainFrame.ST_STATUS_FIELD, "Sleeping for "+i+" seconds, waiting for "+getWaitEvent());
//						}
//
