...
public class TrendGraphColors {
    ...
    Color.pink,
    Color.gray,
    TrendGraphColors.DARK_RED,
    TrendGraphColors.DARK_BLUE,
    TrendGraphColors.DARK_GREEN,
    TrendGraphColors.DARK_YELLOW,
    TrendGraphColors.DARK_MAGENTA,
    TrendGraphColors.DARK_CYAN,
    Color.darkGray,
    TrendGraphColors.LIGHT_RED,
    TrendGraphColors.LIGHT_BLUE,
    TrendGraphColors.LIGHT_GREEN,
    TrendGraphColors.LIGHT_YELLOW,
    TrendGraphColors.LIGHT_MAGENTA,
    TrendGraphColors.LIGHT_CYAN,
    Color.lightGray,
    TrendGraphColors.VERY_DARK_RED,
    TrendGraphColors.VERY_DARK_BLUE,
    TrendGraphColors.VERY_DARK_GREEN,
    TrendGraphColors.VERY_DARK_YELLOW,
    TrendGraphColors.VERY_DARK_MAGENTA,
    TrendGraphColors.VERY_DARK_CYAN,
    TrendGraphColors.VERY_LIGHT_RED,
    TrendGraphColors.VERY_LIGHT_BLUE,
    TrendGraphColors.VERY_LIGHT_GREEN,
    TrendGraphColors.VERY_LIGHT_YELLOW,
    TrendGraphColors.VERY_LIGHT_MAGENTA,
    TrendGraphColors.VERY_LIGHT_CYAN
    };

	private TrendGraphColors(Color[] _colors) {
