...
public class IqTune
{
	private static Logger _logger = Logger.getLogger(IqTune.class);
...
//		_cmdLine = cmd;
		...
		String defaultPropsFile     = (IQTUNE_HOME           != null) ? IQTUNE_HOME           + File.separator + CONFIG_FILE_NAME      : CONFIG_FILE_NAME;
...
//				}
//			};
//			runProfiler.setName("IqTune-Profiler");
...
//			runProfiler.start();
	...
	private static void printHelp(Options options, String errorStr)
	{
		...
		pw.println("usage: iqtune [-C <cfgFile>] [-c <cfgFile>] [-t <filename>] [-h] [-v] ");
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			//-------------------------------
			// Start IqTune, GUI/NOGUI will be determined later on.
			//-------------------------------
			else
			{
				new IqTune(cmd);
