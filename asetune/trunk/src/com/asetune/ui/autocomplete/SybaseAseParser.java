...
//		com.asetune.parser.sybase.ase.SybaseAseParser parser = new com.asetune.parser.sybase.ase.SybaseAseParser(tokens);
//
...
//try
//{
//					// 2.2 Getting a com.asetune.parser manager for a specific vendor
//					// The recommended way is to instantiate a com.asetune.parser based on the
...
//					// the com.asetune.parser based on the vendor information
...
//		
//					// get the best matching com.asetune.parser manager depending on what com.asetune.parser
...
//	// in which case a generic com.asetune.parser is returned
