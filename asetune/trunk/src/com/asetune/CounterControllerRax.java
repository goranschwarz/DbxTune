...
{
	private static Logger _logger = Logger.getLogger(CounterControllerRax.class);
...
//	throws Exception
	...
	throws Exception
	{
		...
		_logger.info("Initializing all CM objects, using Replication Agent version number "+srvVersion+".");
