...
public class CheckForUpdates2Ase extends CheckForUpdatesDbx
{
	private static Logger _logger = Logger.getLogger(CheckForUpdates2Ase.class);
...
//	{
//System.out.println(">>>>>> CheckForUpdates2Ase >>>>>>>>> TRACE: createCheckForUpdate()");
//		// URL TO USE
...
//	public QueryString createSendConnectInfo(int connType, SshTunnelInfo sshTunnelInfo)
	...
	{
System.out.println(">>>>>> CheckForUpdates2Ase >>>>>>>>> TRACE: createSendConnectInfo()");
...
//	public List<QueryString> createSendMdaInfo()
	...
	{
System.out.println(">>>>>> CheckForUpdates2Ase >>>>>>>>> TRACE: createSendMdaInfo()");
		if ( ! MonTablesDictionary.hasInstance() )
		{
			_logger.debug("MonTablesDictionary not initialized when trying to send connection info, skipping this.");
			return null;
...
//	{
//System.out.println(">>>>>> CheckForUpdates2Ase >>>>>>>>> TRACE: createSendUdcInfo()");
//		// URL TO USE
...
//	{
//System.out.println(">>>>>> CheckForUpdates2Ase >>>>>>>>> TRACE: createSendCounterUsageInfo()");
//		// URL TO USE
...
//	{
//System.out.println(">>>>>> CheckForUpdates2Ase >>>>>>>>> TRACE: createSendLogInfo()");
