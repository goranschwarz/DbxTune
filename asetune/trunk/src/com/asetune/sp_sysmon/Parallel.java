...
public class Parallel extends AbstractSysmonType
{
	public Parallel(SpSysmon sysmon, CountersModel cm)
	{
		super(sysmon, cm);
	}

	public Parallel(SpSysmon sysmon, long srvVersion, int sampleTimeInMs, List<List<Object>> data, int fieldName_pos, int groupName_pos, int instanceId_pos, int value_pos)
	{
	...
	{
		return "Parallel Query Management";
	}
