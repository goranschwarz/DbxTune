...
export CLASSPATH=$CLASSPATH:$ASETUNE_HOME/lib/log4j-1.2.17.jar
export CLASSPATH=$CLASSPATH:$ASETUNE_HOME/lib/h2-1.3.169.jar
...
export CLASSPATH=$CLASSPATH:$ASETUNE_HOME/lib/swingx-all-1.6.4.jar
...
export CLASSPATH=$CLASSPATH:$ASETUNE_HOME/lib/proxy-vole_20120920.jar
