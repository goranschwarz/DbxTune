...
//	}
	...
	public void init(List sessionList)
	{
		...
		for (Iterator it = sessionList.iterator(); it.hasNext();) 
		{
			...
			List sessionSamples = sessionInfo._sampleList;
...
//	}
	...
	protected class SessionLevel
	{
		...
		ArrayList _allSamples      = new ArrayList();
...
//		}
		private void addAllSamples(List sampleList)
		{
