 ...
 */
public class CmAdminStatsRsi
extends CmAdminStatsAbstract
{
//	private static Logger        _logger          = Logger.getLogger(CmAdminStats.class);
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmAdminStatsRsi.class.getSimpleName();
	public static final String   MODULE_NAME      = "RSI";
	public static final String   SHORT_NAME       = "Replication Server Interface";
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmAdminStatsRsi(counterController, guiController);
	}

	public CmAdminStatsRsi(ICounterController counterController, IGuiController guiController)
	{
