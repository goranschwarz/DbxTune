...
//		md.addStatColumn("mpc",      x,  x, true, 7,  1, "The total number of inter-processor calls");
...
//		md.addStatColumn("int",     xx,  x, true, 7,  1, "The total number of interrupts.");
...
//		md.addStatColumn("mig",     xx, xx, true, 7,  1, "The total number of thread migrations (to another logical processor).");
...
//		md.addStatColumn("lpa",     xx, xx, true, 7,  1, "The logical processor affinity. The percentage of logical processor redispatches within the scheduling affinity domain 3.");
...
//		md.addStatColumn("lcs",     xx, xx, true, 7,  1, "The total number of logical CPU context switches. Displayed only in shared partition or when dedicated partition is donating.");
//		md.addStatColumn("idon",    xx, xx, true, 7,  1, "The percentage of physical processor utilization that occurs while explicitly donating idle cycles. Displayed only in dedicated partition that is donating.");
//		md.addStatColumn("bdon",    xx, xx, true, 7,  1, "The percentage of physical processor utilization that occurs while donating busy cycles. Displayed only in dedicated partition that is donating.");
...
//		md.addStatColumn("nsp",     xx, xx, true, 7,  1, "The current average processor speed as a percentage of nominal speed. Displayed only if the hardware uses the SPURR.");
