...
//			"<A HREF=\"http://www.asemon.se\">http://www.asemon.se</A><br>" +
		...
		if ( showWhatsNew )
		{
			String whatsNewUrl = _cfu.getWhatsNewUrl();//default is: "http://www.asemon.se/history.html";
			try
			{
				_logger.info("AseMon What's new page is '"+whatsNewUrl+"'.");
		...
		if ( showFeedback )
		{
			...
			try
			{
				_logger.info("AseMon feedback page is '"+feedbackUrl+"'.");
