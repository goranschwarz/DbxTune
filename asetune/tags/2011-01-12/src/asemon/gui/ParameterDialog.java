	...
	implements ActionListener
{
	...
	private ParameterDialog(Frame owner, String title, LinkedHashMap<String, String> input)
	{
	...
	public static Map<String, String> showParameterDialog(Frame owner, String title, LinkedHashMap<String, String> input)
	{
...
//		_apply.setEnabled(enabled);
	...
	public static void main(String[] args)
	{
		...
		in.put("Yupp",             "kalle");
		Map<String,String> results = showParameterDialog(null, "Test Parameters", in);
