...
extends AlarmEvent 
{
	...
	public AlarmEventLowDbFreeSpace(CountersModel cm, String dbname, int freeSpaceInMb, double usedSpaceInPct, int thresholdInMb)
	{
		super(
				...
				"Low DB DATA Free Space in Server '" + cm.getServerName() + "' and dbname '" + dbname + "', FreeSpaceInMB="+freeSpaceInMb+", UsedSpaceInPcs="+usedSpaceInPct+". (thresholdInMb="+thresholdInMb+")",
				thresholdInMb
				);
	...
	public AlarmEventLowDbFreeSpace(CountersModel cm, String dbname, int freeSpaceInMb, double usedSpaceInPct, double thresholdInPct)
	{
		super(
				...
				AlarmEvent.Severity.WARNING, 
				AlarmEvent.ServiceState.UP, 
				"Low DB DATA Free Space in Server '" + cm.getServerName() + "' and dbname '" + dbname + "', FreeSpaceInMB="+freeSpaceInMb+", UsedSpaceInPcs="+usedSpaceInPct+". (thresholdInPct="+thresholdInPct+")",
				thresholdInPct
				);
