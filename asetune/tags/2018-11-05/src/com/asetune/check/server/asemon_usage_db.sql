...
CREATE TABLE dbxc_store_info
(
	checkId                 int,
	serverAddTime           timestamp,
	userName                varchar(30),
	
	shutdownReason          varchar(30),
	wasRestartSpecified     int,
	
	writerJdbcUrl           varchar(1024),
	H2DbFileSize1InMb       int,
	H2DbFileSize2InMb       int,
	H2DbFileSizeDiffInMb    int,
	
	PRIMARY KEY (checkId, serverAddTime)
);

CREATE TABLE dbxc_store_srv_info
(
	checkId                 int,
	serverAddTime           timestamp,
	userName                varchar(30),
	...
	srvName                 varchar(30),
	dbxProduct              varchar(30),

	firstSamleTime          timestamp        NOT NULL,
	lastSamleTime           timestamp            NULL,
	
	alarmCount              int,
	receiveCount            int,
	receiveGraphCount       int,
