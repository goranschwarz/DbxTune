...
//	public static final String CONFIG_TYPE          = "ParameterType";
	...
	//   --------------------- --------- -------------- --------------- --------------------------------------------
		...
		{CONFIG_VALUE,         false,    String .class, "varchar(255)", "Value of the configuration."},
		{RUN_VALUE,            false,    String .class, "varchar(255)", "RUN Value of the configuration."},
		{DEFAULT_VALUE,        false,    String .class, "varchar(255)", "The default configuration value."},
