...
implements ActionListener, MouseListener
{
	...
	private int                _defaultPanelMinHeight = 114;
	...
	public JPopupMenu createPanelPopupMenu()
	{
		...
		mi.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				in.put(key1, Integer.toString( (_panelMinHeight <= 0 ? _defaultPanelMinHeight : _panelMinHeight) ));
...
//			_panel.setPreferredSize(new Dimension(406, 160));
			...
			_panel.setMinimumSize(new Dimension(-1, (_panelMinHeight <= 0 ? _defaultPanelMinHeight : _panelMinHeight) ));
...
//				if (_cm != null)
//				{
//					TabularCntrPanel tabPanel = _cm.getTabPanel();
//					if (tabPanel != null)
//					{
//						boolean cmHasActiveGraphs = _cm.hasActiveGraphs();
//
//						if (cmHasActiveGraphs)
//						{
//							_cm.setBackgroundDataPollingEnabled( true, false );
//							tabPanel.setEnableBgPollingCheckbox( false );
//						}
//						else
//						{
//							_cm.setBackgroundDataPollingEnabled( false, false );
//							tabPanel.setEnableBgPollingCheckbox( true );
//						}
//					}
//				}
				saveProps();
