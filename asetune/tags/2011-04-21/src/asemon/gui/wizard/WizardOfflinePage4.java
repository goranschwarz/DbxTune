...
//	private static Logger _logger          = Logger.getLogger(WizardOfflinePage4.class);
	...
	private JLabel     _noHostMonWasSelected = new JLabel("<html><b>No Host Monitor, Performance Counter was selected.</b></html>");
...
//	private boolean    _firtsTimeRender = true;
	...
	public WizardOfflinePage4()
	{
		...
		_sshPassword.setToolTipText("Password, you can override this with the '-p' command line switch when starting AseMon in no-gui mode, and yes the stored value is encrypted.");
