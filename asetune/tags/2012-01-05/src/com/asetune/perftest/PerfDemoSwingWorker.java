...
/*
 * This file will be removed/replaced by something else
 * 
 * QUICK FIX TO SET MAX_WORKER_THREADS
 * COPY OF SUNS: SwingWorker.java
 * 
 */
 ...
 * @since 1.6
 */
public abstract class PerfDemoSwingWorker<T, V> implements RunnableFuture<T> {
    /**
...
//    private static final int MAX_WORKER_THREADS = 10;
    ...
    private static synchronized ExecutorService getWorkersExecutorService() {
        ...
        Object obj = appContext.get(PerfDemoSwingWorker.class);
        if (obj == null) {
            ...
            ThreadFactory threadFactory = 
                new ThreadFactory() {
                    ...
                    public Thread newThread(final Runnable r) {
                        ...
                        thread.setName("PerfDemoSwingWorker-" 
                            + thread.getName());
                        return thread;
                    }
                };
            ...
            appContext.put(PerfDemoSwingWorker.class, obj);
        }
