 ...
 */
public class CmErrolog
extends CountersModelAppend
{
//	private static Logger        _logger          = Logger.getLogger(CmErrolog.class);
	private static final long    serialVersionUID = 1L;

	public static final String   CM_NAME          = CmErrolog.class.getSimpleName();
...
//	@Override public boolean getDefaultIsNegativeDiffCountersToZero() { return NEGATIVE_DIFF_COUNTERS_TO_ZERO; }
	...
	public static CountersModel create(ICounterController counterController, IGuiController guiController)
	{
		...
		return new CmErrolog(counterController, guiController);
	}

	public CmErrolog(ICounterController counterController, IGuiController guiController)
	{
...
//	{
//		return new CmErrologPanel(this);
//	}
