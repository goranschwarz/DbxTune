...
{
//	private static final Logger  _logger	           = Logger.getLogger(CmOsVmstatPanel.class);
	private static final long    serialVersionUID      = 1L;

//	private static final String  PROP_PREFIX           = CmOsVmstat.CM_NAME;

	public CmOsVmstatPanel(CountersModel cm)
	{
		super(cm);
